...
class newfile(file_get_params):
	...
	def create_default_video_parameters(self,filename):
		...
		self.file_properties["sub_position"]="bottom" # subtitle position
...
class file_properties(newfile):
	...
	def get_widgets(self):
		...
		w=self.tree.get_object("sub_position_top")
		self.file_properties["sub_position"] = w.get_active() and "top" or "bottom"
	...
	def set_widgets(self):
		...
		sub_position_id = "sub_position_%s" % self.file_properties["sub_position"]
		w=self.tree.get_object(sub_position_id)
		w.set_active(True)
